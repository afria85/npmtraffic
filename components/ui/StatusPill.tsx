export default function StatusPill({ status }: { status: "YES" | "NO" }) {
  ...
  const className = isYes
    ? "inline-flex items-center justify-center rounded-full border border-amber-300 bg-amber-100 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.25em] text-amber-900 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-200"
